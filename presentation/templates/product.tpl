...
<form action="{$obj->mEditActionTarget}" target="_self"
 method="post" class="edit-form">
  <p>
    <input type="submit" name="submit_edit" value="Mahsulotni Tahrirlash" />
  </p>
</form>
{/if}
{if $obj->mLinkToContinueShopping}
<a href="{$obj->mLinkToContinueShopping}">Xaridni Davom ettirish</a>
{/if}
<h2>Shu ka'bi mahsulotlarni bizning Katalogdan toping:</h2>
<ol>
